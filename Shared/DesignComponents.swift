...
/// Izgara metrik kartı: ad + değer + birim + mini eğri.
/// Varsayılan nötr; `valueColor` verilirse büyük sayı hedefe göre renklenir
/// (yalnızca hedeften sapan kartlarda — kırmızı YOK, sapma turuncu ile gösterilir).
/// `secondary` ikincil bir alt satır ekler (ör. "7g ort 148 g").
